...
public interface GrundListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code strucDefinitionExpression}
	 * labeled alternative in {@link GrundParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterStrucDefinitionExpression(GrundParser.StrucDefinitionExpressionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code strucDefinitionExpression}
	 * labeled alternative in {@link GrundParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitStrucDefinitionExpression(GrundParser.StrucDefinitionExpressionContext ctx);
	/**
